...
class VoicePipelineAgent(utils.EventEmitter[EventTypes]):
    ...
    async def say(
        ...
        *,
        ...
        logger.info(f"checking inside say: {self._playing_speech}, {self._speech_q}")
        if hasattr(self._playing_speech, "nested_speech_done"):
            logger.info(f"checking inside say: {self._playing_speech.nested_speech_done}")
